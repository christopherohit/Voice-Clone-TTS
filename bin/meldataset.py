...
# _letters_ipa = "ɑt̪ɐɒæɓʙβɔɕçɗɖðʤəɘɚɛɜɝɞɟʄɡɠɢʛɦɧħɥʜɨɪʝɭɬɫɮʟɱɯɰŋɳɲɴøɵɸθœɶʘɹɺɾɻʀʁɽʂʃʈʧʉʊʋⱱʌɣɤʍχʎʏʑʐʒʔʡʕʢǀǁǂǃˈˌːˑʼʴʰʱʲʷˠˤ˞↓↑→↗↘'̩'ᵻ"
# _extra = " ̪̪̪"
# _extra2 = '̃'
# _extra3 = '̃'
...
#         for char in text:
#             try:
#                 if char not in self.word_index_dictionary.keys():
#                     pass
#                 else:
